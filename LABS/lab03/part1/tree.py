...
def draw_bunches(point_start, angle_start, length_start):
    ...
    for angle_delta in angle_list:
        ...
        sd.line(start_point=point_start, end_point=point_end_f, color=sd.COLOR_GREEN, width=2)
...
sd.line(start_point=point_root, end_point=point_end, color=sd.COLOR_GREEN, width=2)
